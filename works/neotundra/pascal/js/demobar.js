...
rtl.module("program",["System","ChartJS"],function () {
  ...
  $mod.$main = function () {
    ...
    $mod.dataset.data = [65,59,80,81,56,55,40];
    $mod.dataset.backgroundColor = ["rgba(255, 99, 132, 0.2)","rgba(255, 159, 64, 0.2)","rgba(255, 205, 86, 0.2)","rgba(75, 192, 192, 0.2)","rgba(54, 162, 235, 0.2)","rgba(153, 102, 255, 0.2)","rgba(201, 203, 207, 0.2)"];
    $mod.dataset.borderColor = ["rgb(255, 99, 132)","rgb(255, 159, 64)","rgb(255, 205, 86)","rgb(75, 192, 192)","rgb(54, 162, 235)","rgb(153, 102, 255)","rgb(201, 203, 207)"];
    $mod.dataset.borderWidth = 1;
    $mod.config.data.datasets = [$mod.dataset];
    $mod.config.options = new Object();
    $mod.config.options.scales = new Object();
    $mod.radialLinear = new Object();
    $mod.radialLinear.ticks = new Object();
    $mod.radialLinear.ticks.beginAtZero = true;
    $mod.config.options.scales.yAxes = [$mod.radialLinear];
