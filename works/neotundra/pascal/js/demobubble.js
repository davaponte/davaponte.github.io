...
rtl.module("ChartJS",["System","JS"],function () {
  "use strict";
  var $mod = this;
  rtl.createClassExt($mod,"TChartXYRData",Object,"",function () {
    this.$init = function () {
      this.x = undefined;
      this.y = undefined;
      this.r = undefined;
...
rtl.module("program",["System","ChartJS"],function () {
  ...
  $mod.$main = function () {
    ...
    $mod.dataset.label = "First Dataset";
    $mod.dataset.data = [pas.ChartJS.TChartXYRData.$create("new$1",[20,30,15]),pas.ChartJS.TChartXYRData.$create("new$1",[40,10,10])];
...
//# sourceMappingURL=demobubble.js.map
