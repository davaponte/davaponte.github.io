...
rtl.module("program",["System","JS","Math","ChartJS"],function () {
  "use strict";
  var $mod = this;
  ...
  $mod.$main = function () {
    ...
    $mod.config.data.datasets.push($mod.dataset);
    $mod.dataset = new Object();
    $mod.dataset.label = "My Third dataset";
    $mod.dataset.borderColor = "rgb(75, 192, 192)";
    $mod.dataset.backgroundColor = "rgb(75, 192, 192)";
    $mod.dataset.data = [$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor()];
    $mod.config.data.datasets.push($mod.dataset);
    $mod.dataset = new Object();
    $mod.dataset.label = "My Four dataset";
    $mod.dataset.borderColor = "rgb(255, 205, 86)";
    $mod.dataset.backgroundColor = "rgb(255, 205, 86)";
    $mod.dataset.data = [$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor(),$mod.randomScalingFactor()];
    $mod.config.data.datasets.push($mod.dataset);
