...
rtl.module("program",["System","ChartJS"],function () {
  ...
  $mod.$main = function () {
    ...
    $mod.config.type = "doughnut";
    $mod.config.data = new Object();
    $mod.config.data.labels = ["Red","Blue","Yellow"];
    $mod.dataset = new Object();
    $mod.dataset.data = [300,50,100];
    $mod.dataset.backgroundColor = ["rgb(255, 99, 132)","rgb(54, 162, 235)","rgb(255, 205, 86)"];
    $mod.config.data.datasets = [$mod.dataset];
    new Chart("myChart",$mod.config);
  };
});
//# sourceMappingURL=demodoughnut.js.map
