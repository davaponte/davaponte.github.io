...
rtl.module("program",["System","JS","Web","SysUtils","ChartJS"],function () {
  "use strict";
  var $mod = this;
  this.createConfig = function (mode, intersect) {
    var Result = null;
    var dataset = null;
    Result = new Object();
    Result.type = "line";
    Result.data = new Object();
    Result.data.labels = ["January","February","March","April","May","June","July"];
    Result.data.datasets = new Array();
    dataset = new Object();
    ...
    Result.options.title = new Object();
    Result.options.title.display = true;
    Result.options.title.text = "Mode: " + mode + ", intersect = " + pas.SysUtils.BoolToStr$1(intersect,"true","false");
    Result.options.tooltips = new Object();
    Result.options.tooltips.mode = mode;
    Result.options.tooltips.intersect = intersect;
    Result.options.hover = new Object();
  ...
  this.ctx = null;
  $mod.$main = function () {
    $mod.container = document.querySelector(".demoarea");
    $mod.hovers = new Array();
    $mod.hover = new Object();
    $mod.hover.mode = "index";
    $mod.hover.intersect = true;
    $mod.hovers.push($mod.hover);
    $mod.hover = new Object();
    $mod.hover.mode = "index";
    $mod.hover.intersect = false;
    $mod.hovers.push($mod.hover);
    $mod.hover.mode = "dataset";
    $mod.hover.intersect = true;
    $mod.hovers.push($mod.hover);
    $mod.hover.mode = "dataset";
    $mod.hover.intersect = false;
    $mod.hovers.push($mod.hover);
    $mod.hover.mode = "point";
    $mod.hover.intersect = true;
    $mod.hovers.push($mod.hover);
    $mod.hover.mode = "point";
    $mod.hover.intersect = false;
    $mod.hovers.push($mod.hover);
    $mod.hover.mode = "nearest";
    $mod.hover.intersect = true;
    $mod.hovers.push($mod.hover);
    $mod.hover.mode = "nearest";
    $mod.hover.intersect = false;
    ...
    $mod.hover.mode = "y";
    $mod.hover.intersect = false;
    $mod.hovers.forEach(function (element, index, arr) {
      var Result = false;
      var details = null;
      $mod.div_ = document.createElement("div");
      $mod.div_.classList.add("chart-container");
      $mod.canvas = document.createElement("canvas");
      $mod.div_.appendChild($mod.canvas);
      $mod.container.appendChild($mod.div_);
      $mod.ctx = $mod.canvas.getContext("2d");
      details = rtl.getObject(element);
      $mod.config = $mod.createConfig(details.mode,details.intersect);
      new Chart($mod.ctx,$mod.config);
      return Result;
    });
  };
});
//# sourceMappingURL=demointeractions.js.map
