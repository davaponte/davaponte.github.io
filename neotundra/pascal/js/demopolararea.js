...
rtl.module("program",["System","ChartJS"],function () {
  ...
  $mod.$main = function () {
    ...
    $mod.config.type = "polarArea";
    $mod.config.data = new Object();
    $mod.config.data.labels = ["Red","Green","Yellow","Grey","Blue"];
    $mod.dataset = new Object();
    $mod.dataset.data = [11,16,7,3,14];
    $mod.dataset.backgroundColor = ["rgb(255, 99, 132)","rgb(75, 192, 192)","rgb(255, 205, 86)","rgb(201, 203, 207)","rgb(54, 162, 235)"];
    $mod.config.data.datasets = [$mod.dataset];
    new Chart("myChart",$mod.config);
  };
});
//# sourceMappingURL=demopolararea.js.map
